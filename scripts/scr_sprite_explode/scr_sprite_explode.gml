/// @description scr_sprite_explode(Max Life, Min Life, Max Speed, Min Speed, Max Peice Size, Min Peice Size, Spin, Fade Out, Fade Amt, Fade To Color, End Color, Color Fade Speed, Implode);
/// @function scr_sprite_explode
/// @param Max Life
/// @param  Min Life
/// @param  Max Speed
/// @param  Min Speed
/// @param  Max Peice Size
/// @param  Min Peice Size
/// @param  Spin
/// @param  Fade Out
/// @param  Fade Amt
/// @param  Fade To Color
/// @param  End Color
/// @param  Color Fade Speed
/// @param  Implode
...
for (i = 0; i < ww; i += argument4) {
    for (j = 0; j < hh; j += argument4) {
        particle = instance_create_layer((x - xoff) + i, (y - yoff) + j, "Particles", obj_demo_particle_new);  // Create the particle
