...
if(loot)
{
	...
	var pts = round(100 + (100 * global.combo / 25));
	score += pts;
	p = instance_create_layer(x, y, "DamageText", obj_message);
	p.colour = make_colour_rgb(95, 225, 45);
	p.colour2 = make_colour_rgb(59, 134, 32);
	p.text = "+" + string(pts);
	global.combo++;
}
else
{
	...
	//if(global.particles) effect_create_above(ef_spark, x, y, 2, make_colour_rgb(255, 153, 153));
